...
if(isset($_POST['signupSubmit'])){
    ...
    if(!empty($_POST['email'])){
		...
		if($prevUser > 0){
			...
			if($update){
				$resetPassLink = 'http://localhost/forgot_password_recovery/resetPassword.php?fp_code='.$uniqidStr;
				...
				<br/><br/>Regards,
				<br/>NepaliMovieArchive';
				//set content-type header for sending HTML email
				$headers = "MIME-Version: 1.0" . "\r\n";
				$headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
				//additional headers
				$headers .= 'From: nepalimoviearchive@gmail.com' . "\r\n";
				//send email
